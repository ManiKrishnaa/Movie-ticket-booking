...
app.use(cors(
    {
        origin : {"http://movie-ticket-booking-eight.vercel.app"},
        methods : {"POST","GET"},
        credintials : true
    }
));
...
mongoose.connect('mongodb+srv://manikrishna9970:manikrishna9970@nani.8rxselx.mongodb.net/?retryWrites=true&w=majority&appName=nani/moviebooking')
.then(()=>{
