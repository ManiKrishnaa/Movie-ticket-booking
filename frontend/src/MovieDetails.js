...
function MovieDetails() {
  ...
  useEffect(() => {
    const fetchMovieDetails = async () => {
      ...
      try {
        const response = await axios.get(`https://movie-ticket-booking-gold.vercel.app/moviess/${id}`);
  ...
  const handletime = async (showtime, theater) => {
    ...
    try {
      ...
      const response = await axios.get(`https://movie-ticket-booking-gold.vercel.app/movies/${id}/${encodedTheater}/${showtime}/${encodedDate}`);
